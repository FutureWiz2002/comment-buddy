...
function setEditorTheme(monaco: any) {
  console.log("Inside setEditorTheme")
    ...
    <div className="items-center justify-items-center  font-[family-name:var(--font-geist-sans)] my-10">
      <main className="items-center">
        <div>
          ...
          <p>Tired of documenting your codes? Use this tool to add comments to your code so everyone can understand the magic you have done</p>
        </div>
        <div className="flex">
          <div className="m-3">
            <p>Input Code:</p>
